   ...
   <>
    ...
    <div className="bg-[rgba(0,0,0,0.5)] w-full h-full flex items-center justify-center">
     <div className="w-full h-full flex flex-col items-center text-white justify-center">
      <h3 className='text-white font-bold text-3xl mb-4'>Plan Your <span className='text-orange-500'>Trip</span></h3>
      <p className='text-white'>Find your <span className='text-orange-500'>Packages</span></p>
     </div>
    </div>
  </div>
                ...
                >
                 ...
                 <img
                  ...
                  <div className="flex items-center justify-center absolute bottom-0 w-full">
                    <button className="bg-orange-500 w-full  mt-1 rounded-b-lg py-[5px] px-4 text-white text-xs">
                      Book Now
                    </button>
                  </div>
                </div>
