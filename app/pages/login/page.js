    ...
    <div className="bg-[url('/Images/bg.jpg')] w-full bg-cover bg-center h-screen">
      <div className="bg-[rgba(0,0,0,0.7)] flex items-center justify-center w-full h-full">
        <div className="md:w-[50%] h-[350px] bg-white rounded-md grid grid-cols-2  w-full">
          ...
          initial={{opacity:0}}
          transition={{duration:0.2,delay:0.2,ease:'easeInOut'}} className=" w-full h-full px-4">
            <div className="flex my-4 justify-center w-full">
              <h3 className="text-2xl font-bold text-center">Login</h3>
            </div>
            <motion.div animate={{opacity:1}}
          initial={{opacity:0}}
          transition={{duration:0.2,delay:0.3,ease:'easeInOut'}} className="flex flex-col gap-4">
          ...
          transition={{duration:0.2,delay:0.3,ease:'easeInOut'}}
           className="w-full relative h-full  text-white bg-slate-800 overflow-hidden ">
